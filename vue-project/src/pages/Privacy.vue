        ...
        <div class="container my-5">
            ...
            <section>
                ...
                <p>
                    ...
                    Федерального закона
                    от 27.07.2006 № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет
                    порядок обработки персональных данных и меры по обеспечению безопасности персональных данных,
                    предпринимаемые Платоновым Александром Александровичем (далее — Оператор).
                </p>
                <div class="list-item">
                ...
                <div class="list-item">
                    ...
                    применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a
                        href="http://electroshop.com" target="_blank">https://electroshop.com</a>.
                </div>
            </section>
            ...
            <section>
                ...
                <div class="list-item">
                    ...
                    определяемому
                    Пользователю веб-сайта <a href="http://electroshop.com" target="_blank">https://electroshop.com</a>.
                </div>
                <div class="list-item">
                ...
                <div class="list-item">
                    2.10. Пользователь — любой посетитель веб-сайта <a href="http://electroshop.com"
                        target="_blank">https://electroshop.com</a>.
                </div>
                <div class="list-item">
            ...
            <section>
                ...
                <div class="list-item">
                    ...
                    <p>— в случае отзыва субъектом персональных данных согласия на обработку персональных данных, а
                        ...
                        наличии оснований, указанных в Законе о персональных данных;</p>
                ...
                <div class="list-item">
                    ...
                    <p>— сообщать в уполномоченный орган по защите прав субъектов персональных данных по запросу этого
                        органа необходимую информацию в течение 10 дней с даты получения такого запроса;</p>
            ...
            <section>
                ...
                <div class="list-item">
                    ...
                    <p>— требовать от оператора уточнения его персональных данных, их блокирования или уничтожения в
                    ...
                    <p>— на отзыв согласия на обработку персональных данных, а также, на направление требования о
                        прекращении обработки персональных данных;</p>
            ...
            <section>
                ...
                <table style="border-collapse: collapse; width: 100%; border: 1px solid black;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid black; padding: 8px;">Цель обработки</th>
                            <th style="border: 1px solid black; padding: 8px;">Персональные данные</th>
                            <th style="border: 1px solid black; padding: 8px;">Правовые основания</th>
                            <th style="border: 1px solid black; padding: 8px;">Виды обработки персональных данных</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="border: 1px solid black; padding: 8px;">информирование Пользователя посредством
                                отправки электронных писем</td>
                ...
                <div class="list-item">
                    <p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их
                        самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a
                            href="mailto:privacy@electroshop.com">privacy@electroshop.com</a> с пометкой «Актуализация
                        персональных данных».</p>
                </div>
                <div class="list-item">
                    <p>8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны
                        ...
                        направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a
                            href="mailto:privacy@electroshop.com">privacy@electroshop.com</a> с пометкой «Отзыв согласия
            ...
            <section>
                ...
                <div class="list-item">
                    <p>10.1. Оператор до начала осуществления деятельности по трансграничной передаче персональных
            ...
            <section>
                ...
                <div class="list-item">
                    <p>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся
                        обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a
                            href="mailto:privacy@electroshop.com">privacy@electroshop.com</a>.</p>
                    ...
                    <p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a
                            href="https://electroshop.com/privacy" target="_blank">https://electroshop.com/privacy</a>.
                    </p>
                </div>
            </section>
